...
@property (strong, nonatomic) OTSCollectionView *contentView;
...
- (OTSCollectionView *)contentView{
    if (!_contentView) {
        ...
        _contentView = [[OTSCollectionView alloc] initWithFrame:self.bounds collectionViewLayout:flowLayout];
        ...
        [_contentView registerClass:[OTSCollectionViewCell class] forCellWithReuseIdentifier:[OTSCollectionViewCell cellReuseIdentifier]];
    }
    return _contentView;
}
...
- (void)_OTSPageView_setup{
    ...
    [OTSConstraintHelper setView:self.contentView fullAsSuperview:self];
