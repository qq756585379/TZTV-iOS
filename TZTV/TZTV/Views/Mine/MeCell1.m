...
//        [self.iconIV setCircleImage:account.user_image andPlaceHolderImg:@"head"];
        self.nameLabel.text=[NSString stringWithFormat:@"昵称:%@",account.nickName?account.nickName:@""];
        self.desLabel.text=[NSString stringWithFormat:@"帐号:%@",account.account?account.nickName:@""];
